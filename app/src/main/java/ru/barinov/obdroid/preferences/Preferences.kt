...
class Preferences(sharedPreferences: SharedPreferences) {
    ...
    private companion object{
        ...
        const val SAVED_TROUBLE_TYPE = "troubleType"
    }

    var troubleCodeHistoryType by sharedPreferences.int(SAVED_TROUBLE_TYPE, 0)
    ...
    var wifiPort by sharedPreferences.int(WIFI_PORT, 35000)
